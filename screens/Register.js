        ...
        >
            ...
            <Pressable onPress={Keyboard.dismiss} style={styles.container}>
                <SafeAreaView style={styles.inner}>
                    ...
                    <Input title={'Email'} placeholder={'Enter your email...'} style={{ marginBottom: 20 }}/>
                    <Input title={'Password'} placeholder={'Enter your password...'} style={{ marginBottom: 30 }} secureTextEntry/>
